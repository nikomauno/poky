...
SRC_URI = "git://github.com/ToruNiina/toml11;destsuffix=${BP};branch=main;protocol=https \
           git://github.com/nlohmann/json;destsuffix=${BP}/tests/extlib/json;name=json;branch=develop;protocol=https \
           git://github.com/doctest/doctest;destsuffix=${BP}/tests/extlib/doctest;name=doctest;branch=master;protocol=https \
